...
use App\Http\Services\Admin\SpecialtyService;
...
class SpecialtyController extends Controller
{
	...
	{
		$result = [];
		return view('admin.pages.specialties.index', $result);
	}
	...
	*/
	public function loadList(Request $request)
	{
		...
		return [
			'arrData' => view('admin.pages.specialties.list', $result)->render(),
	...
	*/
	public function create()
	{
		...
		return view('admin.pages.specialties.form', $result);
	}
	...
	*/
	public function show(string $id)
	{
		...
		return view('admin.pages.specialties.show', compact('data'));
	}
	...
	* @throws Throwable
	*/
	public function update(UpdateSpecialtyRequest $request, string $id)
	{
		try {
